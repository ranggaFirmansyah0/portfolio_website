...
export default function Navbar() {
	return(
		<div className="fixed w-full bg-[#212121] flex text-[#f5f5f5] py-6 items-center justify-around ">
			...
			<ul className="flex gap-6 flex-1 justify-center">
				...
				<li className="hover:font-medium hover:text-white"><a href="">Project</a></li>
			</ul>
